...
//? 1. Append "e" with the zeroes count to the number. Like: 123e6 is the same as 123 with 6 zeroes 123000000.
//? 2. A negative number after "e" causes the number to be divided by 1 with given zeroes. E.g. 123e-6 means 0.000123 (123 millionths).

//! For different numeral systems:

//? 1. Can write numbers directly in hex (0x), octal (0o) and binary (0b) systems.
//? 2. parseInt(str, base) parses the string str into an integer in numeral system with given base, 2 ≤ base ≤ 36.
