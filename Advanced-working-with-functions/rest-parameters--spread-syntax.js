...
let arrCopy = [...arr7]; // spread the array into a list of parameters
// then put the result into a new array

// do the arrays have the same contents?
alert(JSON.stringify(arr7) === JSON.stringify(arrCopy)); // true

// are the arrays equal?
alert(arr7 === arrCopy); // false (not same reference)
