...
console.log(date5); // shows the correct date
...
let febDateStr = new Date("2012-02-20T03:12");
console.log(febDateStr);
...
let dateEx = new Date(2014, 0, 3); // 3 Jan 2014

console.log(getWeekDay(dateEx)); // should output "WE"
...
let dateEu = new Date(2012, 0, 3); // 3 Jan 2012
console.log(getLocalDay(dateEu)); // tuesday, should show 2
