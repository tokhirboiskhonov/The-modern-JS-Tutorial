...
// For instance, when division / is applied to non-numbers:

console.log("6" / "2"); // output is 3, and its data type is number.

// Here also we can use the Number(value) function to explicitly convert a value to a number:
